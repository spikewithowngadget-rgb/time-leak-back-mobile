...
import 'package:time_leak_flutter/feature/calendar_page/presentation/widget/document_content_preview.dart';
import 'package:time_leak_flutter/feature/calendar_page/presentation/widget/media_file_opener.dart';
...
class MediaItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void openFile() => MediaFileOpener.open(context, file: file, type: type);
          ...
          child: Column(
            ...
            children: [
              ...
              if (type == 'image') ...[
                ...
                GestureDetector(
                  onTap: openFile,
                  child: DocumentContentPreview(file: file),
                ),
              ] else if (type == 'video') ...[
                const SizedBox(height: 10),
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    alignment: Alignment.center,
                    child: Icon(Icons.play_circle_outline_rounded, size: 56, color: AppColors.brandColor1),
                  ),
                ),
              ],
            ],
